...
from src.api.v1.cooperation.schemas import CreateCooperationParams, UpdateCooperationParams, CreateCooperationResp, \
    FetchCooperationsResp
...
@cooperation_app.post("/cooperations", summary="新增合作券商", response_model=CreateCooperationResp)
async def create_cooperation_api(
    ...
    return output_json(data={"cooperation_id": cooperation_id}, message="")


@cooperation_app.delete("/cooperations/{cooperationId}", summary="删除合作券商", response_model=CreateCooperationResp)
...
async def fetch_cooperation_api(
    ...
    return output_json(data=cooperations, total=total, message="")
